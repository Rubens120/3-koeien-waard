...
<body>
    ...
    $(document).ready(function() {
        $('#example').DataTable({
            "language": {
                "lengthMenu": "Toon _MENU_ Studenten per pagina", // Change "entries per page" to "Studenten"
                "zeroRecords": "Geen overeenkomende records gevonden",
                "info": "Toont _START_ tot _END_ van _TOTAL_ Studenten",
                "infoEmpty": "Toont 0 tot 0 van 0 Studenten",
                "infoFiltered": "(gefilterd van _MAX_ totale Studenten)",
                "search": "Zoeken:",
                "paginate": {
                    "first": "Eerste",
                    "last": "Laatste",
